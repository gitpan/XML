# This Makefile is for the XML2 extension to perl.
#
...
#     AUTHOR => q[Martin Owens <DoctorMO{atta}gmail.com>]
#     NAME => q[XML2]
#     PMLIBDIRS => []
#     PREREQ_PM => { Pod::Usage=>q[0], XML::SAX::PurePerl=>q[0] }
#     VERSION_FROM => q[XML2.pm]
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW)\
	  XML2.pm $(INST_MAN3DIR)/XML2.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/XML2.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         XML2' >> META.yml
	$(NOECHO) $(ECHO) 'version:      1.00' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: XML2.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    Pod::Usage:                    0' >> META.yml
	$(NOECHO) $(ECHO) '    XML::SAX::PurePerl:            0' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Martin Owens &lt;DoctorMO{atta}gmail.com&gt;</AUTHOR>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <IMPLEMENTATION>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Pod-Usage" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="XML-SAX-PurePerl" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
